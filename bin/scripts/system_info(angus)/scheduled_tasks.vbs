...
srvFile ="C:\Bin\system_info\servers.txt"
...
strDirectoryb = "C:\Bin\system_info\"
strFileb = "SchJobs.txt"
...
Do Until (objFilea.Line = Lines - 1) 
	...
	strRun = "%comspec% /c schtasks /query /s " & ServerName & " /FO CSV /NH /V >> C:\Bin\system_info\SchJobs.txt"
...
'*****************************************************************************
'*****************************************************************************
strDirectory = "C:\bin\system_info\"
strFile = "schJobs.txt"
...
strDirectory2 = "C:\bin\system_info\"
strFile2 = "SchJobs_report.txt"
Set objFSO2 = CreateObject("Scripting.FileSystemObject")
Set objFile2 = objFSO2.OpenTextFile(strDirectory2 & strFile2, ForWriting, True)



objFile2.writeline("ServerName , TaskName , LastStatus , RunAsUser")  
objFile2.writeline("===============================================") 
...
Do Until (objFile.AtEndOfStream) 
	...
	If (Char = Chr(34)) Then		
		...
		objFile2.writeline(splitstr(0) & " , " & splitstr(1) & " , "  & splitstr(6) & " , "  & splitstr(19)) 
...
'email the results
Set objShell = WScript.CreateObject("WScript.Shell")
	strRun = "c:\bin\blat.exe " & strDirectory2 & strFile2 & " -s "  & chr(34) & "Scheduled Tasks Within the wwteam.net AD"  & chr(34) & "  -to amurray@opentext.com"
	objShell.Run strRun, 0, True
